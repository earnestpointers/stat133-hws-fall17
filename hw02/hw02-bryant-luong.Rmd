...
#### 2) Importing the data into R using `read.csv()` and `read_csv()`
```{r read}

# Use read.csv() to read csv into R and check with str()
base <- read.csv(file = "data/nba2017-player-statistics.csv",
...
rdr <- read_csv(file = "data/nba2017-player-statistics.csv", 
